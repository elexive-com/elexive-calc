              ...
              >
                ...
                <div className="flex items-start">
                  <div className="w-full">
                    ...
                    <p className="text-xs font-medium text-indigo-800 mb-1">{module.heading}</p>
          ...
          {Object.keys(modulesByPillar).filter(pillar => pillar !== "Discovery").map((pillar, index) => (
            <button
              ...
              className={`
                ...
                ${index === 0 ? 'ml-2' : 'ml-1'} 
                ${activePillar === pillar 
                  ? 'bg-white text-indigo-800 font-bold z-10 border-t-2 border-x-2 border-t-amber-500 border-x-gray-200' 
